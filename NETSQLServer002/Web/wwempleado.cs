...
namespace GeneXus.Programs {
   public class wwempleado : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11empleadoName = GetPar( "empleadoName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11empleadoName, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEMPLEADONAME", AV11empleadoName);
         /* Send saved values. */
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavEmpleadoname_Internalname, "empleado Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmpleadoname_Internalname, AV11empleadoName, StringUtil.RTrim( context.localUtil.Format( AV11empleadoName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavEmpleadoname_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavEmpleadoname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWempleado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START042( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With empleado", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Empleadoname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vEMPLEADONAME"), AV11empleadoName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA042( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavEmpleadoname_Internalname;
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11empleadoName = StringUtil.Concat( StringUtil.RTrim( AV11empleadoName), "%", "");
            /* Using cursor H00042 */
            pr_default.execute(0, new Object[] {lV11empleadoName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A12empleadoPhone = H00042_A12empleadoPhone[0];
               A11empleadoEmail = H00042_A11empleadoEmail[0];
               A10empleadoCI = H00042_A10empleadoCI[0];
               A9empleadoName = H00042_A9empleadoName[0];
               A1empleadoId = H00042_A1empleadoId[0];
               E14042 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11empleadoName = StringUtil.Concat( StringUtil.RTrim( AV11empleadoName), "%", "");
         /* Using cursor H00043 */
         pr_default.execute(1, new Object[] {lV11empleadoName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11empleadoName = GridState.FilterValues("Empleadoname");
            AssignAttri("", false, "AV11empleadoName", AV11empleadoName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("empleadoName", AV11empleadoName);
      }
      ...
      protected void STRUP040( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11empleadoName = cgiGet( edtavEmpleadoname_Internalname);
            AssignAttri("", false, "AV11empleadoName", AV11empleadoName);
      ...
      private void E14042( )
      {
         ...
         edtempleadoName_Link = formatLink("viewempleado.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1empleadoId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"empleadoId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20233241858518", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwempleado.js", "?20233241858518", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtempleadoName_Internalname = "EMPLEADONAME_"+sGXsfl_27_idx;
         edtempleadoCI_Internalname = "EMPLEADOCI_"+sGXsfl_27_idx;
         edtempleadoEmail_Internalname = "EMPLEADOEMAIL_"+sGXsfl_27_idx;
         edtempleadoPhone_Internalname = "EMPLEADOPHONE_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtempleadoName_Internalname = "EMPLEADONAME_"+sGXsfl_27_fel_idx;
         edtempleadoCI_Internalname = "EMPLEADOCI_"+sGXsfl_27_fel_idx;
         edtempleadoEmail_Internalname = "EMPLEADOEMAIL_"+sGXsfl_27_fel_idx;
         edtempleadoPhone_Internalname = "EMPLEADOPHONE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtempleadoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1empleadoId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1empleadoId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtempleadoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtempleadoName_Internalname,(string)A9empleadoName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtempleadoName_Link,(string)"",(string)"",(string)"",(string)edtempleadoName_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtempleadoCI_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A10empleadoCI), 8, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A10empleadoCI), "ZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtempleadoCI_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"CI",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtempleadoPhone_Internalname,StringUtil.RTrim( A12empleadoPhone),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)gxphoneLink,(string)"",(string)"",(string)"",(string)edtempleadoPhone_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"tel",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Phone",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A9empleadoName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtempleadoName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A10empleadoCI), 8, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A11empleadoEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A12empleadoPhone)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavEmpleadoname_Internalname = "vEMPLEADONAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtempleadoName_Link = "";
         edtempleadoId_Jsonclick = "";
         subGrid_Class = "ww__grid";
         subGrid_Backcolorstyle = 0;
         edtavEmpleadoname_Jsonclick = "";
         edtavEmpleadoname_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Work With empleado";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11empleadoName',fld:'vEMPLEADONAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14042',iparms:[{av:'A1empleadoId',fld:'EMPLEADOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtempleadoName_Link',ctrl:'EMPLEADONAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11042',iparms:[{av:'A1empleadoId',fld:'EMPLEADOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11empleadoName',fld:'vEMPLEADONAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11empleadoName',fld:'vEMPLEADONAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11empleadoName',fld:'vEMPLEADONAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11empleadoName',fld:'vEMPLEADONAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11empleadoName = "";
         H00042_A12empleadoPhone = new string[] {""} ;
         H00042_A11empleadoEmail = new string[] {""} ;
         H00042_A10empleadoCI = new int[1] ;
         H00042_A9empleadoName = new string[] {""} ;
         H00042_A1empleadoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwempleado__default(),
            new Object[][] {
                new Object[] {
               H00042_A12empleadoPhone, H00042_A11empleadoEmail, H00042_A10empleadoCI, H00042_A9empleadoName, H00042_A1empleadoId
               }
               , new Object[] {
      ...
      private int edtavEmpleadoname_Enabled ;
      ...
      private string edtavEmpleadoname_Internalname ;
      private string edtavEmpleadoname_Jsonclick ;
      ...
      private string edtempleadoName_Link ;
      ...
      private string AV11empleadoName ;
      private string A9empleadoName ;
      private string A11empleadoEmail ;
      private string lV11empleadoName ;
      ...
      private string[] H00042_A12empleadoPhone ;
      private string[] H00042_A11empleadoEmail ;
      private int[] H00042_A10empleadoCI ;
      private string[] H00042_A9empleadoName ;
      private short[] H00042_A1empleadoId ;
   ...
   public class wwempleado__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A9empleadoName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [empleadoPhone], [empleadoEmail], [empleadoCI], [empleadoName], [empleadoId]";
         sFromString = " FROM [empleado]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11empleadoName)) )
         {
            AddWhere(sWhereString, "([empleadoName] like @lV11empleadoName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [empleadoName]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00042(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H00043(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11empleadoName",GXType.NVarChar,40,0) ,
