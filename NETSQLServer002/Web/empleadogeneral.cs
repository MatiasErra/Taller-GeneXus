   ...
   public class empleadogeneral : GXWebComponent
   {
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110r1_client"+"'", TempTags, "", 2, "HLP_empleadoGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120r1_client"+"'", TempTags, "", 2, "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtempleadoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1empleadoId), 4, 0, ",", "")), StringUtil.LTrim( ((edtempleadoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1empleadoId), "ZZZ9") : context.localUtil.Format( (decimal)(A1empleadoId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtempleadoId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtempleadoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtempleadoName_Internalname, "Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtempleadoName_Internalname, A9empleadoName, StringUtil.RTrim( context.localUtil.Format( A9empleadoName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtempleadoName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtempleadoName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtempleadoCI_Internalname, "CI", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtempleadoCI_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A10empleadoCI), 8, 0, ",", "")), StringUtil.LTrim( ((edtempleadoCI_Enabled!=0) ? context.localUtil.Format( (decimal)(A10empleadoCI), "ZZZZZZZ9") : context.localUtil.Format( (decimal)(A10empleadoCI), "ZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtempleadoCI_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtempleadoCI_Enabled, 0, "text", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "CI", "right", false, "", "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtempleadoEmail_Internalname, A11empleadoEmail, StringUtil.RTrim( context.localUtil.Format( A11empleadoEmail, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A11empleadoEmail, "", "", "", edtempleadoEmail_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtempleadoEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "left", true, "", "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtempleadoPhone_Internalname, "Phone", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtempleadoPhone_Internalname, StringUtil.RTrim( A12empleadoPhone), StringUtil.RTrim( context.localUtil.Format( A12empleadoPhone, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", gxphoneLink, "", "", "", edtempleadoPhone_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtempleadoPhone_Enabled, 0, "tel", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Phone", "left", true, "", "HLP_empleadoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A12empleadoPhone = H000R2_A12empleadoPhone[0];
               AssignAttri(sPrefix, false, "A12empleadoPhone", A12empleadoPhone);
               A11empleadoEmail = H000R2_A11empleadoEmail[0];
               AssignAttri(sPrefix, false, "A11empleadoEmail", A11empleadoEmail);
               A10empleadoCI = H000R2_A10empleadoCI[0];
               AssignAttri(sPrefix, false, "A10empleadoCI", StringUtil.LTrimStr( (decimal)(A10empleadoCI), 8, 0));
               A9empleadoName = H000R2_A9empleadoName[0];
               AssignAttri(sPrefix, false, "A9empleadoName", A9empleadoName);
               /* Execute user event: Load */
               E140R2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202332418575736", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("empleadogeneral.js", "?202332418575736", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtempleadoName_Internalname = sPrefix+"EMPLEADONAME";
         edtempleadoCI_Internalname = sPrefix+"EMPLEADOCI";
         edtempleadoEmail_Internalname = sPrefix+"EMPLEADOEMAIL";
         edtempleadoPhone_Internalname = sPrefix+"EMPLEADOPHONE";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A1empleadoId',fld:'EMPLEADOID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110R1',iparms:[{av:'A1empleadoId',fld:'EMPLEADOID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120R1',iparms:[{av:'A1empleadoId',fld:'EMPLEADOID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000R2_A1empleadoId = new short[1] ;
         H000R2_A12empleadoPhone = new string[] {""} ;
         H000R2_A11empleadoEmail = new string[] {""} ;
         H000R2_A10empleadoCI = new int[1] ;
         H000R2_A9empleadoName = new string[] {""} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empleadogeneral__default(),
            new Object[][] {
                new Object[] {
               H000R2_A1empleadoId, H000R2_A12empleadoPhone, H000R2_A11empleadoEmail, H000R2_A10empleadoCI, H000R2_A9empleadoName
               }
            }
         );
         AV13Pgmname = "empleadoGeneral";
      ...
      private short[] H000R2_A1empleadoId ;
      private string[] H000R2_A12empleadoPhone ;
      private string[] H000R2_A11empleadoEmail ;
      private int[] H000R2_A10empleadoCI ;
      private string[] H000R2_A9empleadoName ;
   ...
   public class empleadogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000R2", "SELECT [empleadoId], [empleadoPhone], [empleadoEmail], [empleadoCI], [empleadoName] FROM [empleado] WHERE [empleadoId] = @empleadoId ORDER BY [empleadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
