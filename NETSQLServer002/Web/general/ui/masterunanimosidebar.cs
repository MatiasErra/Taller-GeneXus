...
namespace GeneXus.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "SIDEBARMENU_MPAGE_Class", StringUtil.RTrim( Sidebarmenu_Class));
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20233241858361", false, true);
      ...
      protected void WB010( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "sidebar__toggle-ico" + " " + ((StringUtil.StrCmp(imgImage1_gximage, "")==0) ? "GX_Image_GeneXusUnanimo_list_view_white_Class" : "GX_Image_"+imgImage1_gximage+"_Class");
            StyleString = "";
            ...
            /* Static images/pictures */
            ClassString = "header__logo" + " " + ((StringUtil.StrCmp(imgImage2_gximage, "")==0) ? "GX_Image_GeneXusUnanimo_genexus_logo_Class" : "GX_Image_"+imgImage2_gximage+"_Class");
            StyleString = "";
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "Obligatorio Genexus", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "header__title", 0, "", 1, 1, 0, 0, "HLP_General\\UI\\MasterUnanimoSidebar.htm");
            ...
            ucSidebarmenu.SetProperty("Class", Sidebarmenu_Class);
      ...
      protected void STRUP010( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Sidebarmenu_Class = cgiGet( "SIDEBARMENU_MPAGE_Class");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20233241858372", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?20233241858372", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
      ...
      private string Sidebarmenu_Class ;
