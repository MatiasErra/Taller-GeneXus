/*
			...
			Description: Attributes
				 Author: Nemo 🐠 for C# (.NET) version 18.0.1.167910
...
namespace GeneXus.Programs.general.ui
{
	...
	[XmlType(TypeName="TransactionContext.Attribute" , Namespace="xd2" )]
	[Serializable]
	...
	[DataContract(Name=@"TransactionContext.Attribute", Namespace="xd2")]
